...
class ContactAddGroup(unittest.TestCase):
    ...
    def test_contact_add_group(self):
        ...
        self.create_contact(wd, name="Adile", middlename="Shemshedinova", lastname="Revanovna", nickname="Adile", company="Django stars", address="Nauki 62A",
    ...
    def create_contact(self, wd, name, middlename, lastname, nickname, company, address, mobile, email, bday, bmonth,
                       byear):
