...
testdata = [
    Contact(firstname="firstname1", middlename="middlename1", lastname="lastname1", nickname="nickname1",
            ...
            workphone="workphone1", secondaryphone="secondatyphone1", email="email1", email2="email21",
            email3="email31"),
    Contact(firstname="firstname2", middlename="middlename2", lastname="lastname2", nickname="nickname2",
            ...
            workphone="workphone2", secondaryphone="secondatyphone2", email="email2", email2="email22",
            email3="email32"),
]
